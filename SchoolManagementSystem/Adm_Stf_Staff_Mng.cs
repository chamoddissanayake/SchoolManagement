...
{
    public partial class Adm_Stf_Staff_Mng : Form
    {
                ...
                dob == "" || appdate == "" || jdate == "" || gender == "" || password == ""))
            {
                ...
                else
                {
                    try
                    {
                        ...
                        cmd2.CommandText = "INSERT INTO Administrative_Staff VALUES('" + stfID + "', '" + designation + "')";
                        ...
                        cmd3.CommandText = "INSERT INTO Administrative_Staff_credentials VALUES('" + stfID + "','" + secpwd + "','" + saltpwd + "')";
        ...
        void FillDataGridView()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM Staff, Administrative_Staff WHERE Staff.stfID = Administrative_Staff.stfID";
                cmd.ExecuteNonQuery();
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.CurrentRow.Index != -1)
            {
                ...
                txtDesignation.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (!(stfID == ""))
            {
                try
                {
                    ...
                    SqlCommand cmd1 = sqlCon.CreateCommand();
                    cmd1.CommandType = CommandType.Text;
                    cmd1.CommandText = "DELETE FROM Administrative_Staff_credentials WHERE stfID = '" + stfID + "'";
                    cmd1.ExecuteNonQuery();

                    SqlCommand cmd2 = sqlCon.CreateCommand();
                    cmd2.CommandType = CommandType.Text;
                    cmd2.CommandText = "DELETE FROM Administrative_Staff WHERE stfID = '" + stfID + "'";
                    cmd2.ExecuteNonQuery();
        ...
        private void createDocument()
        {
            ...
            savefiledialog.FileName = "Administrative Staff Report";
            ...
            if (savefiledialog.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefiledialog.FileName, FileMode.Create))
                {
                    ...
                    iTextSharp.text.Image image1 = iTextSharp.text.Image.GetInstance("C:/Users/User/Desktop/SchoolManagementSystem/SchoolManagementSystem/pictures/Administrative staff report header.png");
                    //Fixed Positioning
        ...
        private void specificSearch()
        {
            try
            {
                ...
                SqlCommand cmd = sqlCon.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT * FROM Staff, Administrative_Staff WHERE Staff.stfID = Administrative_Staff.stfID AND Staff.stfID LIKE '%" + Search2.Text + "%'";
                cmd.ExecuteNonQuery();
        ...
        private void Adm_Stf_Staff_Mng_Load(object sender, EventArgs e)
        {
